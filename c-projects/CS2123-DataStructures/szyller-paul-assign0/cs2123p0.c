...
Purpose:
    Goes through the customer input file and fills the customer array with data from this file.
Parameters:
    I Customer customerM[]  customer array to fill.
    I int *piNumCustomer    number of Customers in the array customerM.
Notes:
    Although there is no return value for this function, the variable iNumberOfCustomers in main
    is updated when a new customer is added to the array via pass by reference.
Return Value:
    void
***************************************************************************/
void getCustomerData(Customer customerM[], int *piNumCustomer)
