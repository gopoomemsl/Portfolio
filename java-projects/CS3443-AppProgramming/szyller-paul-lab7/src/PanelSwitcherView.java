 ...
 * the button.
 * <br>
 * Made the JButton object accessible to the whole class and created the 
 * registerListener method to register the controller with the view.
 * 
 * @author Tom Bylander
 * @author Paul Szyller
 */
public class PanelSwitcherView extends JFrame {
    ...
    /**
     * A very simple method to register the controller to the JButton so 
     * that it will switch the JPanels.
     * @param controller
     */
    public void registerListener(PanelSwitcherController controller)
    {
